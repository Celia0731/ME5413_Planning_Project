...
bag = rosbag.Bag('/home/celia/ME5413/homework3/Planning_Project/src/me5413_world/error_original_robot.bag')
...
for i in range(2):
    ...
    save_path = os.path.join('/home/celia/ME5413/homework3/Planning_Project/src/me5413_world/results/original_robot', filenames[i]) 
